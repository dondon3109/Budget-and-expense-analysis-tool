            ...
            {accountBalances && (
              <section className="dashboard-balance" aria-labelledby="dashboard-balance-title">
                <div className="dashboard-balance-total">
                  ...
                  {previousMetrics && (
                    <div
                      className="dashboard-balance-trend"
                      data-state={trendState(netChangePercent)}
                    >
                      <span>
                        {netChangePercent > 0 ? "+" : ""}
                        {netChangePercent}%
                ...
                <section className="dashboard-account-breakdown" aria-label="Account management">
                  ...
                  {accountBalances.items.some((account) => account.archived) && (
                    <details className="dashboard-removed-accounts">
                      ...
                      <p>
                        Removed accounts stay read-only so historical transactions remain accurate.
                      </p>
                      <ul>
                        {accountBalances.items
                          ...
                          .map((account) => (
                            <li key={account.id}>
                              ...
                              <span className="dashboard-account-balances">
                                <strong>
                                  {formatMoney(account.balancesByCurrency.PHP, "PHP")}
                                </strong>
                                {account.balancesByCurrency.USD !== 0 && (
                                  <em>{formatMoney(account.balancesByCurrency.USD, "USD")} USD</em>
                                )}
                      ...
                      <fieldset className="account-interest-fieldset">
                        ...
                        {isPro ? (
                          ...
                          <p className="form-hint account-interest-pro-callout">
                            ...
                            <Link to="/app/settings#plan-and-billing">Upgrade to Zoption Pro</Link>{" "}
                            to earn interest on this savings account.
                          </p>
                        )}
                      </fieldset>
                    )}
            ...
            {removingAccount && (
              <div className="modal-backdrop" role="presentation">
                ...
                >
                  ...
                  <p>
                    It will no longer appear when adding new transactions. Your existing
                    transactions and its calculated balance will remain in your history.
                  </p>
                  <div className="modal-actions">
                    <button
                      className="button secondary"
            ...
            {empty ? (
              ...
              >
                <div className="onboarding-copy">
                  ...
                  <p>
                    Your workspace starts without fictional transactions or budgets. Import a CSV or
                    add a transaction when you are ready, and Zoption will build the overview from
                    your data.
                  </p>
