  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          The data controller responsible for Zoption is Don Leonard E. Estrera, with a business address at Baring, San Isidro, San Francisco, Cebu, Philippines. Our data-protection contact is Don Leonard E. Estrera.

          Privacy questions and requests to access, correct, delete, restrict, or otherwise exercise rights relating to personal data may be submitted through support@zoption.site.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
            ...
            We maintain a documented process for assessing and responding to suspected security incidents. This process may include investigating the incident, containing unauthorized access, mitigating potential harm, restoring affected systems, and notifying affected individuals or relevant authorities when required by applicable law.

            Despite these safeguards, no internet-based service or method of electronic storage can guarantee absolute security. You should keep your login credentials confidential, use a unique password, protect the devices you use to access Zoption, and promptly report suspected unauthorized access to support@zoption.site.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          When you use Zoption’s AI assistant, we send the text of your question and any additional context reasonably necessary to answer it to DeepSeek, a third-party artificial-intelligence service provider. DeepSeek processes this information to generate a response and may also process related technical information for service operation, security, abuse prevention, and troubleshooting.

          DeepSeek may process and store information on servers located in the People’s Republic of China. DeepSeek’s published materials indicate that some user inputs may be used to improve or optimize its services and models, subject to available opt-out controls. Zoption has not confirmed whether its DeepSeek account has opted out of model training. DeepSeek does not publicly specify a fixed retention period for all API inputs or a precise schedule for deleting data from backups.

          Zoption DOES store assistant questions and generated responses in your account history. If assistant history is stored, you may delete it through the Assistant page’s “Delete chat” or “Delete all chats” controls. Deleting information from Zoption may not immediately remove copies independently retained by DeepSeek for security, legal, operational, or other permitted purposes. Requests concerning information processed by DeepSeek may require coordination with that provider.

          Do not include passwords, authentication credentials, payment-card details, government identification numbers, medical information, or other sensitive, confidential, or unnecessary personal information in assistant questions. Only provide information reasonably necessary for the assistant to respond to your request.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We retain personal data only for as long as reasonably necessary for the purposes described in this Privacy Policy, subject to the following general retention periods:

          * **Account and profile information:** Retained while your account remains active. When you request account deletion, we place your account and associated information into our deletion process and aim to remove them from active systems within 30 days, unless continued retention is required by law.

          * **Profile pictures and avatars:** Retained while associated with an active account. They are deleted from active storage when you remove them or as part of the account-deletion process, ordinarily within 30 days.

          * **Financial records you create in Zoption:** Budgets, expenses, income entries, categories, uploaded records, analyses, and related information are retained until you delete them or delete your account. Information remaining when an account is deleted is ordinarily removed from active systems within 30 days.

          * **Assistant conversations:** Questions submitted to the AI assistant and generated responses are retained in your account history until you delete an individual chat, delete all chats, or delete your account. Information independently retained by DeepSeek is subject to DeepSeek’s own retention practices, as described in the Assistant Processing section.

          * **Diagnostic and security information:** Application logs, authentication records, error reports, and security-event information are generally retained for up to 90 days. We may retain relevant records for longer when reasonably necessary to investigate a security incident, prevent fraud or abuse, comply with law, or establish, exercise, or defend legal claims.

          * **Account-deletion queue:** Account-deletion requests are ordinarily processed within 30 days. Some information may be excluded from deletion where retention is legally required or necessary for security, fraud prevention, dispute resolution, or legal claims.

          * **Payment, tax, and business records:** If Zoption offers paid services, invoices, payment records, transaction records, and related accounting information may be retained for up to five years, or for a longer period when required by applicable tax, accounting, or other laws. We do not retain complete payment-card credentials when payments are handled by a third-party payment provider.
      ...
      <section>
        ...
        <p>
          Depending on your location and applicable law, you may have the right to be informed about how your personal data is processed; access or obtain a copy of your personal data; correct inaccurate or incomplete information; object to certain processing; withdraw consent where processing is based on consent; request the erasure or blocking of personal data; receive eligible data in a portable format; and file a complaint with a competent data-protection authority.

          You may delete your Zoption account and associated data through the account deletion control in Account Settings. For access, correction, objection, portability, consent withdrawal, or other privacy requests, contact us at [support@zoption.site](mailto:support@zoption.site) and describe the request and the account concerned.

          We may request information reasonably necessary to verify your identity or your authority to act for another person before processing a request. We will use verification information only for handling and documenting the request. We may limit or deny a request where permitted or required by applicable law, including where fulfilling it would adversely affect another person’s rights, conflict with a legal obligation, or where the request is manifestly unfounded or unreasonable. Where appropriate, we will explain the reason for the decision.

          You may also file a complaint with the Philippine National Privacy Commission or another data-protection authority with jurisdiction over your concern. Exercising your privacy rights will not result in discriminatory treatment, although deleting or restricting information necessary to provide Zoption may prevent some or all features from functioning.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Zoption uses service providers that may process personal data outside the Philippines or the country where you live. Our primary database and application data are processed through Supabase cloud infrastructure, although Supabase and its subprocessors may process limited information in other locations where they operate. Resend processes email addresses, email content, delivery information, and related technical data in the United States and through its subprocessors. When you use the AI assistant, assistant questions, related context, and generated responses may be transferred to and processed by DeepSeek in the People’s Republic of China.

          The privacy and data-protection laws in these locations may differ from those in your country. Zoption remains responsible for personal data under its control when it is transferred to a service provider. We use contractual or other reasonable measures designed to provide a comparable level of protection, including applicable provider data-processing terms, reviewing provider privacy and security practices, restricting transfers to information reasonably necessary to provide the relevant service, and applying appropriate access and security controls.

          Where applicable law requires additional consent or another transfer mechanism, we will take the required steps before making the transfer. You may contact us at [support@zoption.site](mailto:support@zoption.site) for more information about relevant processing locations or safeguards.
        </p>
      </section>
      ...
      <section>
        <h2>10. Children</h2>
        <p>
          Zoption is not intended for children below 18 years old, and
      ...
      <section>
        ...
        <p>
          You may contact us at [support@zoption.site](mailto:support@zoption.site) with questions, privacy requests, or complaints about how Zoption handles your personal data. We will review your concern and may request information reasonably necessary to verify your identity, understand the issue, and respond appropriately.

          You may also have the right to file a complaint with the Philippine National Privacy Commission or another data-protection authority with jurisdiction over your location. We encourage you to contact us first so that we have an opportunity to address your concern, but doing so does not prevent you from contacting a competent authority where permitted by applicable law.

          We may update this Privacy Policy from time to time to reflect changes to Zoption, our data-processing practices, service providers, or applicable legal requirements. We will revise the “Last updated” date when changes take effect. If a change materially affects your rights or how we use personal data, we will provide additional notice through email, an in-service notification, or another appropriate method when required by law.

          Where a change requires your consent, we will request that consent before applying the relevant processing. Where applicable, you may object to the change, withdraw previously provided consent, or stop using Zoption and delete your account through Account Settings.
        </p>
      </section>
    </LegalPageLayout>
  );
