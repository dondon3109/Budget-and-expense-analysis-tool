...
| 1 | Search demand pages | Slice 1 | planned |
| 2 | Signup funnel measurement | Slice 1 | planned |
| 3 | Content freshness guard | Slice 2 | planned |
...
### 1. Search demand pages · needs a decision · Beta
...
- [ ] Design it (spec): `/architect search demand pages`

### 2. Signup funnel measurement · needs a decision
...
**Done when:** a visit, a signup start, an account created, and a first import each show up as one step of a single funnel, consent still gates collection, and no event carries financial detail.
- [ ] Design it (spec): `/architect signup funnel measurement`

## Slice 2: Content upkeep

### 3. Content freshness guard · planned · Beta
...
- [ ] Build it: `/develop content freshness guard`
