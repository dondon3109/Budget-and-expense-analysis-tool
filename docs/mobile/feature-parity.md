...
| Accounts                        | `/api/app/accounts`; D1 accounts                 | Encrypted local read model and offline sync                 | 4         | Dependency-free native create/edit/archive is implemented; balances and interest remain later slices. |
| Categories                      | `/api/app/categories`; D1 categories             | Encrypted local read model and offline sync                 | 4         | Native create/edit/archive and explicit conflict recovery preserve server-owned Free/Pro limits.      |
