...
- Assistant memory now keeps a fact the user explicitly asks it to remember even when the request is phrased as a question, and recognises American Express card groupings when deciding that a value is too sensitive to store.
